...
class MusicPlayer:
    def __init__(self,root):
        ...
        playbtn = Button(buttonframe,text="PLAY",command=self.playsong,width=10,height=1,font=("times new roman",16,"bold"),fg="navyblue",bg="gold").grid(row=0,column=0,padx=10,pady=5)
        ...
        os.chdir(r"E:\Python\python\New folder\songs")
        # Fetching Songs
